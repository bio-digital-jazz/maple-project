...
######SET CORRECT WD###########
setwd("G:/Ishwinder's copy/01 Approved data files from Divisions/04 Breast screening - Ish Copy/22-26_BWS Charts - Cycle 8")
options(scipen = 999)
table2 <- read.csv("bowel_LGA_LHD.csv")
######SET CORRECT WD###########
...
x <- read.csv("Bowel RBCO footnotes 2018.csv") #reading the footnotes files
