...
#Loading data
data <- readRDS(file = "H:/Restricted Share/Metadata Repository Project/Projects/app-surgical-mortality/data/SurgicalOutcomesAppDF.Rda")
data1 <- readRDS(file = "H:/Restricted Share/Metadata Repository Project/Projects/app-surgical-mortality/data/SurgicalOutcomesAppDF2.Rda")
data$Count=1
...
#                           padding-right: 10px;}"))),
  ...
  fluidRow(
    column(3, offset = 0,
           div(HTML("<strong><font style = 'color: rgb(106, 66, 137)' font size = '6' >Surgical Outcomes App</strong></font>")),
