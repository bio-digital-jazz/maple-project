# Generated by Django 2.1.2 on 2018-10-17 05:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateField(blank=True, null=True)),
                ('data_asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='data_asset_roles', to='data_assets.DataAsset')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='data_asset_roles', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='DataElement',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('under_review', models.BooleanField(default=False)),
                ('data_element', models.ManyToManyField(related_name='data_elements', to='data_assets.DataElement')),
